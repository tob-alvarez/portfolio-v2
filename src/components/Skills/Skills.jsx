...
const Skills = () => {
  ...
  return (
    <section className="container py-5 mb-3" >
      <h2 className={`seccion mb-5 text-start ${textColor}`} id="skills">Skills</h2>
      <div className="d-flex flex-column justify-content-start align-items-center">
        <h4 className={`text-start ${textColor}`}>I have experience with the following technologies and frameworks</h4>
